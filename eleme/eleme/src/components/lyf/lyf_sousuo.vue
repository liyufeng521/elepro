...
export default {
    ...
    created() {
        this.dizhi = this.$route.query.data;
    ...
    methods: {
      ...
      tijiao(){
        const api = "https://elm.cangdu.org/v1/pois?city_id=" + this.dizhi.id + "&keyword=" + this.state + "&type=search";
        console.log(api);
        console.log(this.dizhi.id)
        this.$http({
            url:api,
            method:"get",
